# PowerShell script to test the fixed bot commands
Write-Host "Testing BaseBuddy Telegram Bot Commands with fixes..." -ForegroundColor Cyan
...
try {
    Write-Host "Starting bot from: $mainBotPath" -ForegroundColor Cyan
